	...
	return (
		<>
			...
			<div className="flex justify-around items-center">
				...
				<div className="flex items-center">
					<div className="flex items-center">
						...
						<p className="font-inter text-base font-medium tracking-normal leading-none text-center ml-1 mr-2">
							Wish List
						</p>
					</div>
					<div
			...
			<div className="flex bg-black p-4 w-full justify-around">
				<div className="text-white font-inter text-2xl font-bold tracking-normal leading-none text-center">
					50% OFF
				</div>
				<div className="text-white font-inter text-2xl font-bold tracking-normal leading-none text-center">
